...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            ...
            <select name="troom" class="form-control" placeholder="Select">
        ...
        while ($row = mysqli_fetch_array($re)) {
            ...
            switch ($id) {
                case "Superior Room":
                    ...
                    break;
                case "Deluxe Room":
                    $imagePath = "../image/hotel1photo.jpg";
                    break;
                case "Guest House":
                    $imagePath = "../image/hotel4photo.jpg";
                    break;
                case "Single Room":
                    $imagePath = "./../image/hos4.jpg";
                    break;
                default:
            ...
            echo "<div class='roombox'>
                    <div class='text-center no-border'>
                        <img src='$imagePath' alt='$id' class='img-fluid mb-2' style='max-height: 200px; width: auto;'>
                        <h3>" . $row['type'] . "</h3>
